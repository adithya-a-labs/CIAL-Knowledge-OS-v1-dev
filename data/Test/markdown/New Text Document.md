...
&#x20; - \[nuwa-skill](https://github.com/alchaincyf/nuwa-skill/blob/main/README\_EN.md) - Nuwa distills the thinking of anyone — let Musk, Naval, Munger, and Feynman work for you.
...
&#x20; - \[llama-index](https://github.com/run-llama/llama\_index) - A data framework for your LLM application.
...
\- \[feature\_engine](https://github.com/feature-engine/feature\_engine) - sklearn compatible API with the widest toolset for feature engineering and selection.
...
&#x20; - \[factory\_boy](https://github.com/FactoryBoy/factory\_boy) - A test fixtures replacement for Python.
...
&#x20; - \[memory\_graph](https://github.com/bterwijn/memory\_graph) - Visualize Python data at runtime to debug references, mutability, and aliasing.
...
&#x20; - \[pdf\_oxide](https://github.com/yfedoseev/pdf\_oxide) - A fast PDF library for text extraction, image extraction, and markdown conversion, powered by Rust.
...
\- \[attrs](https://github.com/python-attrs/attrs) - Replacement for `\_\_init\_\_`, `\_\_eq\_\_`, `\_\_repr\_\_`, etc. boilerplate in class definitions.
...
\- \[zoneinfo](https://docs.python.org/3/library/zoneinfo.html) - (Python standard library) IANA time zone support. Brings the \[tz database](https://en.wikipedia.org/wiki/Tz\_database) into Python.
...
\- \[cx-Freeze](https://github.com/marcelotduarte/cx\_Freeze) - It is a Python tool that converts Python scripts into standalone executables and installers for Windows, macOS, and Linux.
