...
export default function ExportPreviewDialog({ open, exportId, onOpenChange, onRegenerate }: Props) {
  ...
  const savedIndexingStatus=savedDocument?savedStatusQuery.data?.[savedDocument.document_id]?.indexing_status||savedDocument.indexing_status:'pending';
